//character ani Integer cha code
...
int main()
{
	...
	SinglyLL <char> cobj;		//object character chya LL la present krtoy
	...
	SinglyLL <int> iobj;		//object integer chya LL la present krtoy
