...
int main()
{
	...
	write(1,Data,iRet);  //1 monitor sathi takla  //write la sangitl ki monitor vr display kr read(iret) kelel.
						//printf internally call write system  call ..tyamul as pan kru shkto aapn.
